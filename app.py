...
if "guidance_audio_bytes" not in st.session_state:
    st.session_state.guidance_audio_bytes = None
...
def display_audio_guidance(country, city, vtc_summary, mc_results, salary, savings):
    ...
    if st.button("Generate Guidance", type="primary", use_container_width=True):
    ...
    if st.session_state.get("guidance_text"):
        st.info("📝 Financial Guardian Guidance:")
